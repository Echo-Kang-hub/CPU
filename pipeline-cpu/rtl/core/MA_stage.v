...
module MA_stage(
    ...
    // forwarding data: select correct write-back value for EXMA forwarding
    assign EXMA_load_data = (MA_MemtoReg == `MemtoReg_MEM) ? DM_read_data :
                            (MA_MemtoReg == `MemtoReg_PC4) ? MA_PC_plus_4 :
                            MA_aluout;
